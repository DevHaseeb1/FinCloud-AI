...
class ForecastingService:
    ...
    def forecast_total_cost(self) -> pd.DataFrame:
        ...
        try:
            ...
            forecast.columns = [
                'date', 'predicted_cost', 'lower_bound', 'upper_bound',
                'trend', 'weekly', 'weekly_lower', 'weekly_upper', 'multiplicative_terms'
            ]
    ...
    def get_forecast_summary(self, forecast_df: pd.DataFrame) -> Dict:
        return {
            ...
            'has_trend_component': 'trend' in forecast_df.columns,
            'has_weekly_component': 'weekly' in forecast_df.columns,
        }
